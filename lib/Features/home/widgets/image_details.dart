        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                "Men shirt",
                style: AppTextStyle.roboto20.copyWith(fontSize: 22.sp),
              ),
              Opacity(
                opacity: .5,
                child: Text(
              ...
              Text(
                "Description",
                style: AppTextStyle.roboto20.copyWith(fontSize: 25.sp),
              ),
              Text(
                "This shirt from Giorgio Armani is an ideal choice for a great look on celebrity "
                ...
                children: [
                  ...
                  MaterialButton(
                    ...
                    child: Text(
                      "Add to cart",
                      style:
                          AppTextStyle.roboto16.copyWith(color: Colors.white),
                    ),
                  ),
                  SizedBox(width: 80.w),
                  Container(
                    ...
                    child: Row(
                      children: [
                        Text(
                          "+",
                          style: AppTextStyle.roboto20.copyWith(
                            color: AppColor.red,
                            fontSize: 22,
                          ),
                        ),
